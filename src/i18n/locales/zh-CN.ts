...
export const zhCN: Dict = {
  ...
  'music.title': '音乐工作室',
  'music.subtitle':
    '用 Suno 或任何兼容接口生成歌曲。Bring Your Own Key — 生成的曲目仅保存在浏览器本地。',
  'music.modeSimple': '简单',
  'music.modeCustom': '自定义（含歌词）',
  'music.promptLabel': '描述这首歌',
  'music.promptPlaceholder': '例如：一首关于夏夜追萤火虫的轻快独立流行歌',
  'music.lyricsLabel': '歌词',
  'music.lyricsPlaceholder':
    '[主歌1]\n走过城市灯光\n伴着霓虹起舞\n\n[副歌]\n…',
  'music.styleLabel': '风格 / 流派标签',
  'music.stylePlaceholder': '例如：独立流行, 梦幻, 女声, 110bpm',
  'music.titleLabel': '标题',
  'music.titlePlaceholder': '可选的歌曲标题',
  'music.instrumentalLabel': '纯器乐',
  'music.instrumentalHint': '不生成人声，适合背景音乐。',
  'music.modelLabel': '模型',
  'music.generate': '生成',
  'music.generating': '生成中…',
  'music.cancel': '取消',
  'music.libraryTitle': '你的曲库',
  'music.empty': '还没有曲目',
  'music.emptyHint':
    '生成的曲目会出现在这里。仅保存于当前浏览器，可随时删除或清空。',
  'music.statusPending': '排队中',
  'music.statusStreaming': '流式生成中',
  'music.statusComplete': '已就绪',
  'music.statusFailed': '失败',
  'music.errorNoKey': '请在「设置 → 音乐」中填入 API Key 以开始生成。',
  'music.openSettings': '打开设置',
  'music.deleteTrack': '删除曲目',
  'music.deleteTrackConfirm': '确定要从曲库中移除这首曲目？',
  'music.clearAll': '清空曲库',
  'music.clearAllConfirm': '确定要清空整个本地曲库？',
  'music.downloadTrack': '下载',
  'music.providerSuno': 'Suno（自带 Key）',
  'music.providerAcestep': 'ACE-Step（本地 Gradio）',
  'music.providerCustom': '自定义接口',
  'music.proTipQuickPrompt': '小贴士：写得越具体（情绪、乐器、节奏），效果越好。',
  'music.untitledTrack': '未命名曲目',

  'settings.musicSection': '音乐生成',
  'settings.musicSectionHint':
    '配置音乐工作室使用的后端。当本地守护进程在线时调用会通过它代理；API Key 仅保存在当前浏览器。',
  'settings.musicProvider': '提供方',
  'settings.musicApiKey': 'API Key',
  'settings.musicApiKeyHint':
    '用于 Suno 系网关。本地运行的 ACE-Step 不需要 Key。',
  'settings.musicBaseUrl': '基础地址',
  'settings.musicBaseUrlHint':
    '例如 Suno 网关：https://api.sunoapi.org；ACE-Step：http://localhost:8001。',
  'settings.musicModel': '默认模型',
  'settings.musicModelHint':
    '自由填写。Suno 常见取值：V3_5、V4、V4_5。留空表示使用网关默认值。',
