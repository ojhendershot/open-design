...
- E2E report: $public_origin/$RELEASE_CHANNEL/versions/$RELEASE_VERSION/report/
...
This stable release ships mac arm64 DMG/update ZIP, Windows x64 NSIS installer assets, checksums, updater feed files, and packaged e2e spec reports. Linux AppImage packaging remains optional through the stable Linux lane.
EOF
